...
UPlayerCharacter_MoveComponent::UPlayerCharacter_MoveComponent()
{
	...
	FootstepStimulus = CreateDefaultSubobject<UAIPerceptionStimuliSourceComponent>(TEXT("Stimulus"));
	FootstepStimulus->RegisterForSense(TSubclassOf<UAISense_Hearing>());
	FootstepStimulus->RegisterWithPerceptionSystem();
}


// Called when the game starts
void UPlayerCharacter_MoveComponent::BeginPlay()
{
	Super::BeginPlay();
...
void UPlayerCharacter_MoveComponent::EndPlay(const EEndPlayReason::Type EndPlayReason)
{
...
void UPlayerCharacter_MoveComponent::ToggleCrouch()
{
...
void UPlayerCharacter_MoveComponent::Move()
{
	if(Character != nullptr)
	{
...
void UPlayerCharacter_MoveComponent::Step()
{
	UWorld* World = GetWorld();
	if(World)
	{
		UE_LOG(LogTemp,Warning,TEXT("Step Taken"));
		if(CharacterMovementAbility == EMovementAbility::EmaSprinting)
		{
			FVector Location = Character->GetActorLocation();
			UAISense_Hearing::ReportNoiseEvent(World,Location,1.0,Character,500,TEXT("Noise"));


		}
		else if(CharacterMovementAbility == EMovementAbility::EmaNeutral && CharacterStance != EStance::EStanceCrouched)
		{
			FVector Location = Character->GetActorLocation();
			UAISense_Hearing::ReportNoiseEvent(World,Location,1.0,Character,300,TEXT("Noise"));
		}
	}
}

void UPlayerCharacter_MoveComponent::SpeedCheck()
{
...
void UPlayerCharacter_MoveComponent::CanJump()
{
	if(Character != nullptr)
	{
...
void UPlayerCharacter_MoveComponent::CanVault(bool& Result, FVector& EndingLocation)
{
	if(Character != nullptr)
	{
...
void UPlayerCharacter_MoveComponent::CanVaultToHit(FHitResult VaultHit, bool& Result, FVector& EndingLocation)
{
...
bool UPlayerCharacter_MoveComponent::CheckCapsuleCollision(FVector Center, float HalfHeight, float Radius, bool DrawDebug)
{
...
void UPlayerCharacter_MoveComponent::Vault()
{
...
void UPlayerCharacter_MoveComponent::TickVault(float DeltaTime)
{
...
void UPlayerCharacter_MoveComponent::SetMoveForward(float Val)
{
	MovementVector.Y = Val; 
}

void UPlayerCharacter_MoveComponent::SetMoveRight(float Val)
{
...
void UPlayerCharacter_MoveComponent::Crouch(const float DeltaTime)
{
	if(Character != nullptr)
	{
...
void UPlayerCharacter_MoveComponent::UnCrouch(const float DeltaTime)
{
	if(Character != nullptr)
	{
		UCapsuleComponent* Capsule = Character->GetCapsuleComponent(); 
...
void UPlayerCharacter_MoveComponent::AttatchToPlayer(APlayerCharacter* CharacterPtr)
{
...
// Called every frame
void UPlayerCharacter_MoveComponent::TickComponent(float DeltaTime, ELevelTick TickType, FActorComponentTickFunction* ThisTickFunction)
{
...
void UPlayerCharacter_MoveComponent::LeanCheckAndMove(float DeltaTime) const
{
...
void UPlayerCharacter_MoveComponent::ReturnFromLean(float DeltaTime)
{
...
bool UPlayerCharacter_MoveComponent::StoopedToTarget(float DeltaTime)
{
	if(Character != nullptr)
	{
		UCapsuleComponent* CharacterCapsule = Character->GetCapsuleComponent();
...
FVector UPlayerCharacter_MoveComponent::GetTopOfPlayerScaled()
{
	if(Character != nullptr)
	{
...
FVector UPlayerCharacter_MoveComponent::GetTopOfPlayerStanding()
{
	if(Character != nullptr)
	{
		const UCapsuleComponent*  CharacterCapsule = Character->GetCapsuleComponent();  
...
FVector UPlayerCharacter_MoveComponent::GetBottomOfPlayer()
{
	if(Character != nullptr)
	{
		const UCapsuleComponent*  CharacterCapsule = Character->GetCapsuleComponent(); 
...
bool UPlayerCharacter_MoveComponent::RiseToTarget(float DeltaTime)
{
	if(Character != nullptr)
	{
		UCapsuleComponent* CharacterCapsule = Character->GetCapsuleComponent();
...
FVector UPlayerCharacter_MoveComponent::GetObjectAbovePlayer(bool &ObjectStraightAbove)
{
	FHitResult Hit1; 
...
void UPlayerCharacter_MoveComponent::CanStoop(bool& Result, FVector& ObjectPosition)
{
	if(Character != nullptr)
	{
		FVector CharacterLocation = Character->GetCapsuleComponent()->GetComponentLocation();
...
void UPlayerCharacter_MoveComponent::StartLeaning()
{
	if(Character != nullptr)
	{
...
void UPlayerCharacter_MoveComponent::StopLeaning()
{
	CharacterMovementAbility = EmaReturningFromLean; 
}

void UPlayerCharacter_MoveComponent::StartSprinting()
{
	if(CharacterMovementAbility != EmaLeaning)
	{
...
void UPlayerCharacter_MoveComponent::StopSprinting()
{
	CharacterMovementAbility = EmaNeutral; 
}
