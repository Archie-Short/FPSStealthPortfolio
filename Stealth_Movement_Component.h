...
#include "Stealth_Movement_Component.generated.h"

class AStealth_Character;

UCLASS( ClassGroup=(Custom), meta=(BlueprintSpawnableComponent) )
class PORTFOLIO_MECHANICS_API UStealth_Movement_Component : public UActorComponent
{
	GENERATED_BODY()

public:	
	// Sets default values for this component's properties
	UStealth_Movement_Component();
...
public:	
	void AttatchToPlayer(AStealth_Character* CharacterPtr); 
